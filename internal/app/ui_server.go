...
func (a *UIApp) routes() http.Handler {
	...
	mux.HandleFunc("/api/tvbox/{token}/vod", a.handleTVBoxAPI)
	mux.HandleFunc(tvboxConfigPath, a.handleTVBoxConfig)
	mux.HandleFunc(tvboxCoverPath, a.handleTVBoxCover)
	mux.HandleFunc("/api/tvbox/play/{id}/{chapter}/{key}/index.m3u8", a.handleTVBoxPlay)
	mux.HandleFunc(tvboxPlayM3U8Path, a.handleTVBoxPlay)
